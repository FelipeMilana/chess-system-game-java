...
public class Rook extends ChessPiece{
	...
	public boolean[][] possibleMoves() {
		...
		//above
		p.setValues(position.getRow() - 1, position.getColumn());  //pega a posição da peça, objeto position vem da classe piece
		...
		//left
		p.setValues(position.getRow(), position.getColumn() - 1);  //pega a posição da peça, objeto position vem da classe piece
